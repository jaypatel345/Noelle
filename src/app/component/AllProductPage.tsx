...
function AllProductPage() {
  ...
  return (
    <div className="w-full relative">
      {/* Toggle Button - Fixed on left side - HIDDEN ON DESKTOP (lg:hidden) */}
      <button
        onClick={toggleMenu}
        className="fixed top-4 left-4 z-50 bg-black text-white p-3 rounded-full shadow-lg hover:bg-gray-800 transition-colors duration-200 lg:hidden"
      ...
      <div className={`
        min-h-screen px-4 mt-6 lg:mt-10 transition-all duration-300
        ${isMenuOpen ? 'lg:ml-56' : 'lg:ml-0'} lg:ml-56 lg:mr-16
      `}>
