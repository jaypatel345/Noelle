  ...
  return (
    <div className="w-full ">
      <div className="flex w-full mx-auto ">
        {/* Sidebar */}
        <MenuBar currentPage="Best Sellers" />
        {/* Hero Image */}
        <div className="relative w-[80%] h-[400px] mt-13 opacity-95">
          ...
          />
          {/* Title */}
          <div className="absolute bottom-0 left-0 w-full bg-black/40 py-4 px-6">
            <h1 className={`${playfair.className} text-4xl text-white font-bold`}>
              Best Sellers
            </h1>
          </div>
        </div>
      </div>
      <div className=" h-screen  ml-56 mr-16 mt-10">
